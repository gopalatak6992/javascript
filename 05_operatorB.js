...
console.log("Q.Variable name that can be used to strore funcetion is:")
...
greaterNumber(899, 800);
 ...
 console.log("Q.check-- 29, 44, 0, 101  --even or odd number")
...
console.log("---------------------------------------------------");
console.log("Q. which word has even or odd length JavaScript, developer, google ");
